...
const AirPlayer: React.FC<AirPlayerProps> = ({
  artistProfileId
}) => {
  const {
    airs,
  ...
  return <Card>
      ...
      <CardContent>
        ...
        {selectedVideo && <VideoPlayerModal isOpen={videoModalOpen} onClose={() => {
        setVideoModalOpen(false);
        setSelectedVideo(null);
      }} videoSrc={getVideoUrl(selectedVideo)} title={selectedVideo.title} description={selectedVideo.description} />}
      </CardContent>
    </Card>;
};
