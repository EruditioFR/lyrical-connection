  ...
  return (
    <section className="bg-gradient-to-r from-lyrical-900 to-gold-900 text-white py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6 text-appear">
          <h2 className="text-3xl md:text-4xl font-serif font-bold">
            Prêt à rejoindre la communauté de la musique lyrique ?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
            <Button 
              className="w-full sm:w-auto px-8 py-6 text-lg bg-white hover:bg-white/90 text-lyrical-900"
              asChild
            >
              <Link to="/inscription">
                Créer un compte
